...
function checkRegistry()
{
  ...
  if (app.name == "Navigator") {          
  try {
    var key = new RegKey();
    key.open(RegKey.prototype.ROOT_KEY_CLASSES_ROOT, "NavigatorHTML\\shell\\open\\command", key.ACCESS_READ);
    ...
    LOG("failed to open command key for NavigatorHTML: " + e);
  }
  key.close();
  }
  return result;
